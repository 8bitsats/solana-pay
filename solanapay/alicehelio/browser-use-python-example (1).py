...
# Integrated with Solana Pay for instant, low-cost cryptocurrency payments
...
def create_x402_payment_task(amount: float, token: str, recipient: str) -> Dict[str, Any]:
    """Create a Browser-Use task for X402 payment completion via Solana Pay"""
    ...
    instructions = f"""
    Complete X402 payment via Solana Pay:
